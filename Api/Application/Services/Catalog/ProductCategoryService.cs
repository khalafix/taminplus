...
namespace Application.Services.Catalog
{
    public class ProductCategoryService : IProductCategoryService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(ProductCategoryDto model)
        {
        ...
        public async Task<GoldiranActionResult<ProductCategoryDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<ProductCategoryDto>();
        ...
        public async Task<GoldiranActionResult<List<ProductCategoryDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<ProductCategoryDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductCategoryDto>>> GetUserList(int count = 8)
        {
            var result = new GoldiranActionResult<List<UserProductCategoryDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductCategoryDto>>> GetUserByParentId(int count = 8, string category = "")
        {
            var result = new GoldiranActionResult<List<UserProductCategoryDto>>();
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetCategoryByParentId(string category)
        {
            category = DataUtility.RemoveDashForTitle(category);
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetSubCategoryByCategoryAndBrand(string category, string brand)
        {
            category = DataUtility.RemoveDashForTitle(category);
        ...
        public async Task<GoldiranActionResult<List<UserProductCategoryDto>>> GetUserById(int id = 1)
        {
            var result = new GoldiranActionResult<List<UserProductCategoryDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductCategoryDto>>> GetUserAllList()
        {
            var result = new GoldiranActionResult<List<UserProductCategoryDto>>();
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> Search(string text, string code)
        {
            var result = new GoldiranActionResult<List<TreeDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(ProductCategoryDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetTree(int? parentId = null)
        {
            var result = new GoldiranActionResult<List<TreeDto>>();
        ...
        public async Task<GoldiranActionResult<List<FeatureDto>>> GetFeatures(int categoryId)
        {
        ...
        public async Task<GoldiranActionResult<List<UserFeatureDto>>> GetFeatureOptionByCategoryId(int categoryId)
        {
            var result = new GoldiranActionResult<List<UserFeatureDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserFeatureDto>>> GetFeaturesByCategoryId(string category, string brand)
        {
            var result = new GoldiranActionResult<List<UserFeatureDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserFeatureDto>>> GetFeaturesBySubCategoryId(string category, string brand, string subCategory)
        {
            var result = new GoldiranActionResult<List<UserFeatureDto>>();
        ...
        public async Task<GoldiranActionResult<FeatureDto>> GetFeaturesByTitle(string category)
        {
        ...
        public async Task<GoldiranActionResult<List<FeatureDto>>> GetFeaturesForSearch(int categoryId)
        {
            var result = new GoldiranActionResult<List<FeatureDto>>();
            var features = await context.ProductCategoryFeatures.Include(q => q.Feature).Include(q => q.Feature.Symbol)
                .Where(q => q.CategoryId == categoryId)
        ...
        public async Task<GoldiranActionResult<ProductCategoryForDashboardDto>> GetProductCategoryForDashboard()
        {
            var result = new GoldiranActionResult<ProductCategoryForDashboardDto>();
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetCategoriesForMegaMenu()
        {
            var result = new GoldiranActionResult<List<TreeDto>>();
            var items = new List<TreeDto>();
