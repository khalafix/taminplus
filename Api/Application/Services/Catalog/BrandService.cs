...
namespace Application.Services.Catalog
{
    public class BrandService : IBrandService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(BrandInputModel model)
        {
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetBrandMegaMenu()
        {
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetAllBrandMegaMenu()
        {
            var result = new GoldiranActionResult<List<TreeDto>>();
            var items = new List<TreeDto>();
        ...
        public async Task<GoldiranActionResult<List<BrandForDashboardChart>>> GetBrandProductsForDashboard()
        {
            var result = new GoldiranActionResult<List<BrandForDashboardChart>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductCategoryDto>>> GetUserProductCategoryByBrandId(int brandId)
        {
        ...
        public async Task<GoldiranActionResult<List<UserProductCategoryDto>>> GetUserProductCategoryByBrandTitle(string brand)
        {
            var result = new GoldiranActionResult<List<UserProductCategoryDto>>();
        ...
        public async Task<GoldiranActionResult<BrandDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<BrandDto>();
        ...
        public async Task<GoldiranActionResult<List<BrandDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<BrandDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserBrandDto>>> GetUserList(int count = 8)
        {
            var result = new GoldiranActionResult<List<UserBrandDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserBrandDto>>> GetUserListByProductCategoryId(string category)
        {
            var result = new GoldiranActionResult<List<UserBrandDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(BrandInputModel model)
        {
            var result = new GoldiranActionResult<int>();
