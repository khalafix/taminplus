...
namespace Application.Services.Catalog
{
    public class ProductService : IProductService
    {
        ...
        public async Task<GoldiranActionResult<int>> ImportPriceListWithExcel(IFormFile file, Guid userId)
        {
        ...
        public async Task<GoldiranActionResult<List<UserLogSearchForProductDto>>> GetListUserLogSearchForProduct(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<UserLogSearchForProductDto>>();
        ...
        public async Task<GoldiranActionResult<List<ProductDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<ProductDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetListWithCategory(int categoryId)
        {
        ...
        public async Task<GoldiranActionResult<int>> Update(ProductDto model)
        {
            var result = new GoldiranActionResult<int>();
            ...
            item.IsShowAlert = model.IsShowAlert;
        ...
        public async Task<GoldiranActionResult<ProductAttachmentDto>> GetProductAttachment(int id)
        {
            var result = new GoldiranActionResult<ProductAttachmentDto>();
        ...
        public async Task<GoldiranActionResult<int>> UpdateProductAttachment(ProductAttachmentInputDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<bool>> DeleteAttachment(Guid attachmentId)
        {
        ...
        public async Task<GoldiranActionResult<ArticleProductInputDto>> GetArticleProductById(int id)
        {
            var result = new GoldiranActionResult<ArticleProductInputDto>();
        ...
        public async Task<GoldiranActionResult<int>> AddArticleProduct(ArticleProductInputDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<VideoProductInputDto>> GetVideoProductById(int id)
        {
            var result = new GoldiranActionResult<VideoProductInputDto>();
        ...
        public async Task<GoldiranActionResult<int>> AddVideoProduct(VideoProductInputDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<FinancialProductDto>> GetFinancialProductById(int id)
        {
            var result = new GoldiranActionResult<FinancialProductDto>();
        ...
        public async Task<GoldiranActionResult<List<FinancialProductDto>>> GetFinancialProductList(int productId)
        {
            var result = new GoldiranActionResult<List<FinancialProductDto>>();
        ...
        public async Task<GoldiranActionResult<int>> UpdateFinancialProduct(FinancialProductDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<List<DeliveryProductDto>>> GetDeliveryProduct(DeliveryProductFilterDto model = null)
        {
            var result = new GoldiranActionResult<List<DeliveryProductDto>>();
            int skip = (model.Page - 1) * model.Size;
        ...
        public async Task<GoldiranActionResult<int>> AddDeliveryProduct(DeliveryProductDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<int>> UpdateDeliveryProduct(DeliveryProductDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<DeliveryProductDto>> GetDeliveryProductById(int id)
        {
            var result = new GoldiranActionResult<DeliveryProductDto>();
        ...
        public async Task<GoldiranActionResult<int>> DeleteDeliveryProduct(int id)
        {
            var result = new GoldiranActionResult<int>();
        ...
        #region User - Product
        public async Task<GoldiranActionResult<List<UserProductDto>>> GetTopVisitedProductList(int count = 8)
        {
            var result = new GoldiranActionResult<List<UserProductDto>>();
            ...
            result.Data = data.Select(q => new UserProductDto
            {
                ...
                Price = q.IsShowAlert == true ? 0 : GetUserProductPrice(q.GetInventoryFromApi, q.APIAmount, q.FinancialProducts),
                DiscountedPrice = q.IsShowAlert == true ? 0 : q.FinancialProducts.Count > 0 ? q.FinancialProducts.OrderByDescending(o => o.CreateDate).FirstOrDefault().DiscountedPrice : 0,
                IsShowAlert = q.IsShowAlert,    
            }).ToList();
        ...
        public async Task<GoldiranActionResult<List<UserProductDto>>> GetTopSaleProductList(int count = 8)
        {
            var result = new GoldiranActionResult<List<UserProductDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductDto>>> GetTopNewProductList(int count = 8)
        {
            var result = new GoldiranActionResult<List<UserProductDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductDto>>> GetUserList(GridQueryModel model = null)
        {
            ...
            if (featuresIds.Count > 0)
            {
                ...
                result.Data = queryResult.ToList().Select(q => new UserProductDto
                {
                    ...
                    Price = q.IsShowAlert == true ? 0 : GetUserProductPrice(q.GetInventoryFromApi, q.APIAmount, q.FinancialProducts),
                    DiscountedPrice = q.IsShowAlert == true ? 0 : q.FinancialProducts.Count > 0 ? q.FinancialProducts.OrderByDescending(o => o.CreateDate).FirstOrDefault().DiscountedPrice : 0,
                    Inventory = q.IsShowAlert == true ? 0 : q.GetInventoryFromApi == true ? q.APIQuantity : q.Inventory,
                    IsShowAlert = q.IsShowAlert,    
                }).Skip(skip).Take(model.Size).ToList();
        ...
        public async Task<GoldiranActionResult<List<string>>> GetAllTitle()
        {
        ...
        public async Task<GoldiranActionResult<UserProductDetailsDto>> GetProductDetail(int id)
        {
            var result = new GoldiranActionResult<UserProductDetailsDto>();
            ...
            var model = new UserProductDetailsDto
            {
                ...
                Price = item.IsShowAlert == true ? 0 : GetUserProductPrice(item.GetInventoryFromApi, item.APIAmount, item.FinancialProducts),
                DiscountedPrice = item.IsShowAlert == true ? 0 : item.FinancialProducts.Count > 0 ? item.FinancialProducts.OrderByDescending(o => o.CreateDate).FirstOrDefault().DiscountedPrice : 0,
        ...
        public async Task<GoldiranActionResult<UserProductDetailsDto>> GetByTitle(string title)
        {
            var result = new GoldiranActionResult<UserProductDetailsDto>();
            title = DataUtility.RemoveDashForTitle(title);
            ...
            {
                if (item.ProductCoverAttachments.FirstOrDefault() !=null)
                {
            ...
            var model = new UserProductDetailsDto
            {
                ...
                CategoryId = item.CategoryId,
                IsActive = item.IsActive,
                Inventory = item.IsShowAlert == true ? 0 : item.GetInventoryFromApi == true ? item.APIQuantity : item.Inventory,
                GetInventoryFromApi = item.GetInventoryFromApi,
                SeoDescription = item.SeoDescription,
                SeoTitle = item.SeoTitle,
                SaleStatus = item.SaleStatus,
        ...
        public async Task<GoldiranActionResult<SimilarDto>> GetSimilarData(int id)
        {
            var result = new GoldiranActionResult<SimilarDto>();
        ...
        public async Task<GoldiranActionResult<List<UserProductDto>>> GetSpecialOfferProductList(int count = 6)
        {
            var result = new GoldiranActionResult<List<UserProductDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserProductDto>>> GetProductsForParentItemsMegaMenu(GridQueryModel filterModel = null)
        {
            var result = new GoldiranActionResult<List<UserProductDto>>();
                        ...
                        foreach (var obj in item.Children)
                        {
                            ...
                            if (productItem != null)
                            {
                                var model = new UserProductDto()
                                {
                                    ...
                                    Price = productItem.IsShowAlert == true ? 0 : GetUserProductPrice(productItem.GetInventoryFromApi, productItem.APIAmount, productItem.FinancialProducts),
                                    DiscountedPrice = productItem.IsShowAlert ==true ? 0 : productItem.FinancialProducts.Count > 0 ? productItem.FinancialProducts.OrderByDescending(o => o.CreateDate).FirstOrDefault().DiscountedPrice : 0,
                                    Inventory = productItem.IsShowAlert == true ? 0 : productItem.Inventory,
                                    EnTitle = productItem.EnName,
                                    IsShowAlert = productItem.IsShowAlert,
        ...
        public async Task<GoldiranActionResult<int>> GetSpecialOfferProductCount()
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<int>> AddFavoriteProduct(FavoriteProductModel model, Guid userId)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<List<FavoriteProductDto>>> GetAllFavoriteProduct(Guid userId)
        {
            var result = new GoldiranActionResult<List<FavoriteProductDto>>();
            ...
            result.Data = data.Select(item => new FavoriteProductDto
            {
                ...
                Price = item.Product.IsShowAlert ==true ? 0 : GetUserProductPrice(item.Product.GetInventoryFromApi, item.Product.APIAmount, item.Product.FinancialProducts),
                DiscountedPrice = item.Product.IsShowAlert == true ? 0 : item.Product.FinancialProducts.Count > 0 ? item.Product.FinancialProducts.OrderByDescending(o => o.CreateDate).FirstOrDefault().DiscountedPrice : 0,
                SaleStatusTitle = item.Product.SaleStatus.Value.GetNameAttribute(),
                IsShowAlert = item.Product.IsShowAlert,
        ...
        public async Task<GoldiranActionResult<bool>> GetByIdFavoriteProduct(Guid userId, int productId)
        {
            var result = new GoldiranActionResult<bool>();
