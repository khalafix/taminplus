...
namespace Application.Services.Support
{
    public class CooperationFormService : ICooperationFormService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(CooperationFormInputModel model)
        {
        ...
        public async Task<GoldiranActionResult<CooperationFormDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<CooperationFormDto>();
        ...
        public async Task<GoldiranActionResult<List<CooperationFormDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<CooperationFormDto>>();
