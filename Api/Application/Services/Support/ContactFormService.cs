...
namespace Application.Services.Support
{
    public class ContactFormService : IContactFormService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(ContactFormInputModel model)
        {
        ...
        public async Task<GoldiranActionResult<ContactFormDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<ContactFormDto>();
        ...
        public async Task<GoldiranActionResult<List<ContactFormDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<ContactFormDto>>();
