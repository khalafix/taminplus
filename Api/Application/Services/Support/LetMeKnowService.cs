...
namespace Application.Services
{
    public class LetMeKnowService : ILetMeKnowService
    {
        ...
        public async Task<GoldiranActionResult<int>> Register(UserLetMeKnowDto model, Guid? userId)
        {
        ...
        public async Task<GoldiranActionResult<List<UserRegisterLetMeKnowDtoDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<UserRegisterLetMeKnowDtoDto>>();
