...
namespace Application.Services
{
    public class UserOpinionService : IUserOpinionService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(UserOpinionDto model)
        {
        ...
        public Task<GoldiranActionResult<int>> Delete(Guid id)
        {
            throw new NotImplementedException();
        }

        public async Task<GoldiranActionResult<List<ListUserOpinionDto>>> GetAll(FilterUserOpinionDto model = null)
        {
            var result = new GoldiranActionResult<List<ListUserOpinionDto>>();
        ...
        public async Task<GoldiranActionResult<UserOpinionDto>> GetById(Guid id)
        {
            var result = new GoldiranActionResult<UserOpinionDto>();
        ...
        public async Task<GoldiranActionResult<List<UserOpinionDto>>> GetByProductId(int ProductId)
        {
            var result = new GoldiranActionResult<List<UserOpinionDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserOpinionDto>>> GetByArticleId(int articleId)
        {
            var result = new GoldiranActionResult<List<UserOpinionDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(UserInputOpinionModel model)
        {
            var result = new GoldiranActionResult<int>();
