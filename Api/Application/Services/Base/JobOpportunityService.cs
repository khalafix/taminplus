...
namespace Application.Services
{
    public class JobOpportunityService : IJobOpportunityService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(JobOpportunityDto model)
        {
        ...
        public async Task<GoldiranActionResult<JobOpportunityDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<JobOpportunityDto>();
        ...
        public async Task<GoldiranActionResult<List<JobOpportunityDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<JobOpportunityDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(JobOpportunityDto model)
        {
            var result = new GoldiranActionResult<int>();
