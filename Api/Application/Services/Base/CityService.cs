...
namespace Application.Services.Base
{
    public class CityService : ICityService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(CityInputModel model)
        {
        ...
        public async Task<GoldiranActionResult<CityDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<CityDto>();
        ...
        public async Task<GoldiranActionResult<List<CityDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<CityDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(CityInputModel model)
        {
            var result = new GoldiranActionResult<int>();
