...
namespace Application.Services
{
    public class EmailTemplateService : IEmailTemplateService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(EmailTemplateDto model)
        {
        ...
        public async Task<GoldiranActionResult<EmailTemplateDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<EmailTemplateDto>();
        ...
        public async Task<GoldiranActionResult<bool>> ResetTemplate(int id)
        {
        ...
        public async Task<GoldiranActionResult<List<EmailTemplateDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<EmailTemplateDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(EmailTemplateDto model)
        {
            var result = new GoldiranActionResult<int>();
