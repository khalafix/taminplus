...
namespace Application.Services
{
    public class ApplicationConfigService : IApplicationConfigService
    {
        ...
        public async Task<GoldiranActionResult<ApplicationConfigDto>> Get()
        {
            var result = new GoldiranActionResult<ApplicationConfigDto>();
        ...
        public async Task<GoldiranActionResult<int>> Update(ApplicationConfigDto model)
        {
