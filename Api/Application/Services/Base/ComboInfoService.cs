...
namespace Application.Services
{
    public class ComboInfoService : IComboInfoService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<ComboInfoDto>> GetComboInfo(Guid userId)
        {
            var result = new GoldiranActionResult<ComboInfoDto>();
            try
            {
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetOrganizationLevel()
        {
            var list = new List<ComboItemDto>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetFeatureCategory()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetProducts(int categoryId)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetCities(Province provinceId)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetJobOpportunities()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetProductsByCategoryIdForUser(int categoryId)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetAllProductsForUser()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetArticles(int categoryId)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetDisciplinesById(int id)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetDisciplines(int? organizationId = null)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetBrands()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetVideoCategory()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetSaleStatus()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetPagesLinkTypes()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetOrderStatus()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetShowStatus()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetUserTypes()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetPositionPlace()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetVideoSource()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetProvince()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetDeliveryType()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetUserOpinionType()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetCountType()
        {
            var list = new List<ComboItemDto>();
            var result = new GoldiranActionResult<List<ComboItemDto>>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetOrigins()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetArticleCategory()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetSymbolWithOutParent()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetVideos(int categoryId)
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
        ...
        public async Task<GoldiranActionResult<List<ComboItemDto>>> GetProductCategory()
        {
            var result = new GoldiranActionResult<List<ComboItemDto>>();
            try
            {
