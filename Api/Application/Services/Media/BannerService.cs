...
namespace Application.Services.Media
{
    public class BannerService : IBannerService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(BannerDto model)
        {
        ...
        public async Task<GoldiranActionResult<BannerDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<BannerDto>();
        ...
        public async Task<GoldiranActionResult<List<BannerDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<BannerDto>>();
        ...
        public async Task<GoldiranActionResult<UserBannerDto>> GetUserList(PositionPlace positionPlace)
        {
            var result = new GoldiranActionResult<UserBannerDto>();
            ...
            switch (positionPlace)
            {
                case PositionPlace.PartOne:
                    result.Data.List = await context.Banners.Include(i => i.BannerAttachments).OrderByDescending(o => o.SortOrder).ThenByDescending(t => t.CreateDate).Where(w => w.PositionPlace == positionPlace)
                          .Select(s => new UserModelBannerDto
                          {
                              ...
                              Title = s.Title,
                              SeoTitle = s.SeoTitle,
                              FileAttachment = s.BannerAttachments.OrderByDescending(o=>o.CreateDate).Select(s => s.FilePath).ToList(),
                          }).ToListAsync();
                    break;
                case PositionPlace.PartTwo:
                    ...
                    if (data !=null)
                    {
                        var model = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = data.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.ImmediateOffer:
                    ...
                    if (dataModel !=null)
                    {
                        var obj = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataModel.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.AboveTheMenu:
                    ...
                    if (dataAboveTheMenuModel != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataAboveTheMenuModel.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.OfferForProductCategory:
                    ...
                    if (dataOfferForProductCategory != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataOfferForProductCategory.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                    ...
                    else
                    {
                        ...
                        if (immediateOffer != null)
                        {
                            var obj = new UserModelBannerDto
                            {
                                ...
                                FileAttachment = immediateOffer.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.OfferForPiece:
                    ...
                    if (dataOfferForPiece != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataOfferForPiece.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.OfferForPieceCategory:
                    ...
                    if (dataOfferForPieceCategory != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataOfferForPieceCategory.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.OfferForBrand:
                    ...
                    if (dataOfferForBrand != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataOfferForBrand.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.OfferForBrandPiece:
                    ...
                    if (dataOfferForBrandPiece != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataOfferForBrandPiece.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.OfferForBrandProductCategory:
                    ...
                    if (dataOfferForBrandProductCategory != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataOfferForBrandProductCategory.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.ProductDetails:
                    ...
                    if (dataProductDetails != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataProductDetails.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                    ...
                    else
                    {
                        ...
                        if (dataAbove != null)
                        {
                            var dataValues = new UserModelBannerDto
                            {
                                ...
                                FileAttachment = dataAbove.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                    ...
                    if (dataBrandFeatures != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataBrandFeatures.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.ProductFeatures:
                    ...
                    if (dataProductFeatures != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            ...
                            FileAttachment = dataProductFeatures.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.PieceCategory:
                    var dataPieceCategory = await context.Banners.Include(i => i.BannerAttachments).OrderByDescending(o => o.SortOrder)
                        .ThenByDescending(t => t.CreateDate).FirstOrDefaultAsync(w => w.PositionPlace == positionPlace);

                    if (dataPieceCategory != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            Id = dataPieceCategory.Id,
                            PositionPlace = dataPieceCategory.PositionPlace,
                            Link = dataPieceCategory.Link,
                            Title = dataPieceCategory.Title,
                            SeoTitle = dataPieceCategory.SeoTitle,
                            FileAttachment = dataPieceCategory.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                    ...
                    {
                        var dataProductFeaturesTemp = await context.Banners.Include(i => i.BannerAttachments).OrderByDescending(o => o.SortOrder).ThenByDescending(t => t.CreateDate)
                            .FirstOrDefaultAsync(w => w.PositionPlace == PositionPlace.ProductFeatures);

                        if (dataProductFeaturesTemp != null)
                        {
                            var dataValues = new UserModelBannerDto
                            {
                                Id = dataProductFeaturesTemp.Id,
                                PositionPlace = dataProductFeaturesTemp.PositionPlace,
                                Link = dataProductFeaturesTemp.Link,
                                Title = dataProductFeaturesTemp.Title,
                                SeoTitle = dataProductFeaturesTemp.SeoTitle,
                                FileAttachment = dataProductFeaturesTemp.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
                ...
                case PositionPlace.BrandPiece:
                    var dataBrandPiece = await context.Banners.Include(i => i.BannerAttachments).OrderByDescending(o => o.SortOrder)
                        .ThenByDescending(t => t.CreateDate).FirstOrDefaultAsync(w => w.PositionPlace == positionPlace);

                    if (dataBrandPiece != null)
                    {
                        var dataValues = new UserModelBannerDto
                        {
                            Id = dataBrandPiece.Id,
                            PositionPlace = dataBrandPiece.PositionPlace,
                            Link = dataBrandPiece.Link,
                            Title = dataBrandPiece.Title,
                            SeoTitle = dataBrandPiece.SeoTitle,
                            FileAttachment = dataBrandPiece.BannerAttachments.OrderByDescending(o => o.CreateDate).Select(s => s.FilePath).ToList(),
        ...
        public async Task<GoldiranActionResult<int>> Update(BannerDto model)
        {
            var result = new GoldiranActionResult<int>();
