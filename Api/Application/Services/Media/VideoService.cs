...
namespace Application.Services.Media
{
    public class VideoService : IVideoService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(VideoDto model)
        {
        ...
        public async Task<GoldiranActionResult<VideoDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<VideoDto>();
        ...
        public async Task<GoldiranActionResult<List<UserVideoDto>>> GetLastVideo()
        {
            var result = new GoldiranActionResult<List<UserVideoDto>>();
        ...
        public async Task<GoldiranActionResult<List<VideoDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<VideoDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserVideoDto>>> GetUserList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<UserVideoDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(VideoDto model)
        {
            var result = new GoldiranActionResult<int>();
