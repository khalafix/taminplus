...
namespace Application.Services.Catalog
{
    public class ArticleService : IArticleService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(ArticleDto model)
        {
        ...
        public async Task<GoldiranActionResult<ArticleDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<ArticleDto>();
        ...
        public async Task<GoldiranActionResult<List<int>>> GetAllId()
        {
            var result = new GoldiranActionResult<List<int>>();
        ...
        public async Task<GoldiranActionResult<List<UserArticleDto>>> GetLastArticle()
        {

            var result = new GoldiranActionResult<List<UserArticleDto>>();
        ...
        public async Task<GoldiranActionResult<List<ArticleDto>>> GetList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<ArticleDto>>();
        ...
        public async Task<GoldiranActionResult<List<UserArticleDto>>> GetUserList(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<UserArticleDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(ArticleDto model)
        {
            var result = new GoldiranActionResult<int>();
