...
namespace Application.Services
{
    public class CustomerService : ICustomerService
    {
        ...
        public CustomerService(BIContext context, IGenericQueryService<User> userQueryService, IGoldiranService goldiranService, ISmsService smsService, ILogger<CustomerService> logger)
        {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<CustomerDto>>> GetCustomers(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<CustomerDto>>();
            ...
            foreach (var item in model.Filtered)
            {
                ...
                if (item.column == "natinalCode")
                {
                    filterModel.NatinalCode = item.value;
                }
            }
            ...
            (string.IsNullOrEmpty(filterModel.UserName) || q.User.PhoneNumber.Contains(filterModel.UserName)) &&
               (string.IsNullOrEmpty(filterModel.NatinalCode) || q.User.PhoneNumber.Contains(filterModel.NatinalCode))
            );
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<CustomerInputModel>> AddCustomer(CustomerInputModel model, bool isAdmin = true)
        {
            var result = new GoldiranActionResult<CustomerInputModel>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<CustomerInputModel>> UpdateCustomer(CustomerInputModel model, bool isAdmin = true)
        {
            var result = new GoldiranActionResult<CustomerInputModel>();
            ...
            if (customer != null)
            {
                ...
                customer.NatinalCode = model.NatinalCode;
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<CustomerInputModel>> UpdateCustomerByUser(CustomerInputModel model)
        {
            var result = new GoldiranActionResult<CustomerInputModel>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<CustomerInputModel>> UpdateCustomerInfoByUser(CustomerInputModel model)
        {
            var result = new GoldiranActionResult<CustomerInputModel>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<Guid>> UpdatePassword(ChangePasswordInputModel model, bool isCurrentUser)
        {
        ...
        /// <returns></returns>
        public async Task<GoldiranActionResult<CustomerDto>> GetCustomerById(Guid userId)
        {
            var result = new GoldiranActionResult<CustomerDto>();
            ...
            if (customer != null)
            {
                var model = new CustomerDto
                {
                    ...
                    NatinalCode = customer.NatinalCode,
                };
                result.Data = model;
            }
        ...
        public async Task<GoldiranActionResult<AuthenticateModel>> RegisterCustomer(RegisterCustomerInputModel model)
        {
            ...
            {
                logger.LogError(" ( " + "Service :" + "{" + " /api/CustomerService/RegisterCustomer " + "}" + " - " + ex.Message + "  ");
