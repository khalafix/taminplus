...
namespace Application.Services
{
    public class RoleService : IRoleService
    {
        ...
        public async Task<GoldiranActionResult<int>> Add(RoleDto model)
        {
        ...
        public async Task<GoldiranActionResult<RoleDto>> GetById(int id)
        {
            var result = new GoldiranActionResult<RoleDto>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<RoleDto>>> GetRoles(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<RoleDto>>();
        ...
        public async Task<GoldiranActionResult<int>> Update(RoleDto model)
        {
            var result = new GoldiranActionResult<int>();
        ...
        public async Task<GoldiranActionResult<List<RoleGroupPermissionDto>>> GetRolePermissions(int roleId)
        {
            var result = new GoldiranActionResult<List<RoleGroupPermissionDto>>();
        ...
        public async Task<GoldiranActionResult<int>> UpdateRolePermissions(int roleId, List<RolePermissionDto> permissions)
        {
            var result = new GoldiranActionResult<int>();
         ...
         public async Task<GoldiranActionResult<List<TreeDto>>> GetRoleTree(int? parentId)
        {
        ...
        public async Task<GoldiranActionResult<List<TreeDto>>> GetOragnizationChartData(int? parentId = null)
        {
            var result = new GoldiranActionResult<List<TreeDto>>();
            var roles = await context.Roles.Where(q => parentId == null || (q.ParentId == parentId || q.Id == parentId)).ToListAsync();
            var rootElement = roles.FirstOrDefault(q => q.ParentId == null);
