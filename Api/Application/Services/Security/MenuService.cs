...
namespace Application.Services
{
    public class MenuService : IMenuService
    {
        ...
        public async Task<GoldiranActionResult<List<MenuDto>>> GetMenu()
        {

            var result = new GoldiranActionResult<List<MenuDto>>();
            try
            {
        ...
        public async Task<GoldiranActionResult<List<MenuDto>>> GetMenuAccessForUser(Guid UserId)
        {
            var result = new GoldiranActionResult<List<MenuDto>>();
            try
            {
