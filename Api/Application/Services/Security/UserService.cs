...
namespace Application.Services
{
    public class UserService : IUserService
    {
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<List<UserDto>>> GetUsers(GridQueryModel model = null)
        {
            var result = new GoldiranActionResult<List<UserDto>>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<UserInputModel>> AddUser(UserInputModel model, Guid userId)
        {
            var result = new GoldiranActionResult<UserInputModel>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<UserInputModel>> UpdateUser(UserInputModel model, Guid userId)
        {
            var result = new GoldiranActionResult<UserInputModel>();
        ...
        /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<Guid>> DeleteUser(Guid userid)
        {
        ...
        /// /// </summary>
        /// <returns></returns>
        public async Task<GoldiranActionResult<bool>> ChangeEmailSignature(ChangeEmailSignatureInputModel model)
        {
        ...
        /// <returns></returns>
        public async Task<GoldiranActionResult<UserDto>> GetUserById(Guid userid)
        {
            var result = new GoldiranActionResult<UserDto>();
        ...
        /// <param name="userid"></param>
        /// <returns></returns>
        public async Task<GoldiranActionResult<string>> GetEmailSignuature(Guid userid)
        {
        ...
        public async Task<List<ComboItemDto>> GetUsersForCombo()
        {
            ...
            var data = await context.Users.Where(i => i.IsActive == true && i.UserType == UserType.TaminPlus).Select(x => new ComboItemDto
            {
                Value = x.Id,
