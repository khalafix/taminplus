...
namespace Application.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        public async Task<GoldiranActionResult<bool>> CheckUserIsExsits(string phoneNumber)
        {
        ...
        public async Task<GoldiranActionResult<bool>> CheckUserIsExsitsForActive(string phoneNumber)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<AuthenticateModel>> GenerateTokenWithRefreshTokenAsync(string token, string currentRefreshToken, string ip, string browser)
        {
        ...
        public async Task<GoldiranActionResult<AuthenticateModel>> LoginAsync(LoginDto model, string ip, string browser)
        {
            var result = new GoldiranActionResult<AuthenticateModel>();
            #region Validation
            ...
            try
            {
                ...
                var loginModel = new AuthenticateModel
                {
                    ...
                    IsCompany = (user.UserType != null && user.UserType.Value == UserType.TaminPlus) ? false : true,
        ...
        public async Task<GoldiranActionResult<UserAuthenticateModel>> CustomerLoginAsync(LoginDto model, string ip, string browser)
        {
        ...
        public async Task<(GoldiranActionResult<bool>, Guid?)> RegisterAsync(RegisterDto model, string ip, string browser)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> ConfirmationAsync(Guid code, string ip, string browser)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<Guid>> ResetPasswordConfirmation(Guid code, string ip, string browser)
        {
        ...
        public async Task<GoldiranActionResult<bool>> SendResetPasswordLink(SendResetPasswordLinkDto model, string ip, string browser)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> ResetPassword(ResetPasswordDto model, string ip, string browser)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> ChangePasswordAsync(ResetPasswordDto model, string ip, string browser)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> ChangePasswordForUserAsync(ResetPasswordDto model, string ip, string browser)
        {
            var result = new GoldiranActionResult<bool>();
