...
namespace Application.Services.Sms
{
    public class SmsService : ISmsService
    {
        ...
        private async Task<string> GenrateCode()
        {
            ...
            var code = Nanoid.Nanoid.Generate("0123456789", 6).ToString();

            while (await context.UserSmss.AnyAsync(a => a.Code == code))
            {
                code = Nanoid.Nanoid.Generate("0123456789", 6).ToString();
            }
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForgetPasswordForAdmin(Guid userid)
        {
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForAlerts(string userName, string password)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForRequestAlerts(Guid userId , string alert)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForgetPassword(string userName)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForConfirmPhoneNumber(Guid userid, string phoneNumber)
        {
            var result = new GoldiranActionResult<bool>();
            var user = await context.Users.SingleOrDefaultAsync(s => s.Id == userid);
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForRegisterUser(string phoneNumber)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> SendSmsForActiveUser(string phoneNumber)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<List<SmsDto>>> GetList(GridQueryModel model)
        {
            var result = new GoldiranActionResult<List<SmsDto>>();
        ...
        public async Task<GoldiranActionResult<bool>> CheckCodeSmSForPhoneNumber(string code, Guid userId)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> CheckCodeSmSForRegisterUser(string code, string phoneNumber)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<bool>> CheckCodeSmSForActiveUser(string code, string phoneNumber)
        {
            var result = new GoldiranActionResult<bool>();
        ...
        public async Task<GoldiranActionResult<Guid>> CheckCodeSmSForForgetPasswordUser(string code, string userName)
        {
