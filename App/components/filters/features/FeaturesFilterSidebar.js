...
const FilterSidebar = ({ props }) => {
    ...
    useEffect(() => {
        ...
        for (let index = 0; index < props.features.length; index++) {
            const element = props.features[index];
    ...
    return (
        <>
            <form onSubmit={handleSubmit(onSubmit)} >
                ...
                <Card className={`mt-2  font-weight-bold `}  >
                    ...
                    data != null && data?.length > 0 ?
                        ...
                        <Card className={`mt-3 font-weight-bold  `}  >
                            <Card.Header style={{ background: "none" }}>
                                {data.length > 0 && data[0].featureTitle + " " + removeDash(props.subcategory)}
...
const FeaturesFilterSidebar = (props) => {
...
export default FeaturesFilterSidebar;