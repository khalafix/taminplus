...
const DynamicFromForUserOpinion = ({productId, handleClose}) => {
    ...
    const onSubmit = async (data) => {
        ...
        model.userOpinionType=UserOpinionType.Products;
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <>
                    ...
                    <Card.Body >
                        ...
                        <Button type='button' className='mb-2' value='add more' onClick={addClickPlus} variant="success" size='sm' >+ نکات مثبت محصول </Button>

                        <ListGroup >{createInputsPlus()}</ListGroup>
                        <hr />
                        <Button type='button' className='mb-2' value='add more' onClick={addClickNegative} variant="danger" size='sm' > - نکات منفی محصول </Button>
...
export default DynamicFromForUserOpinion;