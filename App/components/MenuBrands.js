            ...
            ? data.map((item, index) => {
                return (
                  ...
                  <li
                    ...
                    onMouseEnter={() => setActiveCatSubMenuIndex(index)}
                    className="rmm__nav-item  nav-sub-item"
                    role="none"
                  >
                    <Link
                      // href={`${link}${item.key}`}
                    ...
                    >
                      ...
                      >
                        <span
                          onmouseover={() => onmouseover(item.title)}
                          className=""
                        >
                          {" "}
                          {item.title}{" "}
                        ...
                        <NavList
                          ...
                          activeState={
                            activeMenus.includes(
                              `menu-Mega-Menu-Sub-menu-item-0`
                            )
                              ? "open"
                              : "closed"
                          }
                              ...
                              <>
                                ...
                                >
                                  <NavItemLink
                                    ...
                                    href={
                                      type == 1
                                        ? `/product/category/${childItem.key}`
                                        : `/brandcategory/${item.key}/${childItem.key}`
                                    }
                                  >
                                  ...
                                  childItem.children.map((childchildItem) => {
                                    return (
                                      <NavItem
                                        ...
                                        className="nav-sub-sub-sub-item"
                                      >
                                        <NavItemLink
                                          id={`${childchildItem.key}`}
