...
import { removeItem, addItem, removeItemCount, getCount } from 'redux/actions/shoppingCardActions';
...
const Profile = (props) => {
    ...
    return (
                                ...
                                hasToken == true ?
                                    <>
                                        ...
                                        >
                                                ...
                                                <div className="price-table mrb-30 text-center">
...

                                                    {
                                                        loadingGetData ?
                                                            ...
                                                            <button style={{ marginTop: "5%", backgroundColo: 'red', ransition: "all 0.3s", loadingStyleButton }} className="btn cs-btn-one  text-white  text-bold btn-sm  mx-auto m-0 p-1 d-block">
                                                            ...
                                                            <div className="table-content">
                                                                <form onSubmit={handleSubmit(onSubmitUserInfo)}>
                                                                    <div className="row font-weight-bold" >
                                                                        ...
                                                                        <div className="form-group col-md-4">
                                                                            <label className="fl-r" for="email"> ایمیل </label>
                                                                            <input style={{ fontFamily: "SDF" }} ref={register({
                                                                                required: false,
                                                                                email: (value) => {
                                                                        ...
                                                                        <div className="form-group col-md-4">
                                                                            <label className="text-right" for="city"><span className="text-danger">*</span>  استان محل سکونت</label>
                                                                            {
                                                                        ...
                                                                        <div className="form-group col-md-12">
                                                                            <label className="fl-r" for="address"><span className="text-danger">*</span>   آدرس محل سکونت</label>
                                                                            <input style={{ fontFamily: "SDF" }} ref={register({
                                                                                required: true,

                                                                            })} type="text" className="form-control input-sm  font-weight-bold" name="address" placeholder="  آدرس محل سکونت" />
                                                                            {errors.address?.type === "required" && <div className="form-text text-danger"> آدرس محل سکونت الزامی می باشد</div>}
                                                                        </div>
                                            ...
                                            <Tab eventKey="favoriteProducts" title={`  لیست علاقه مندی ها `} >
                                                                                            ...
                                                                                            <Link href={`/product/${getUrl(q.enTitle ? q.enTitle : q.productName)}`}>
                                                                                                ...
                                                                                                <li className="shopping-card-product-item  " style={{ direction: "ltr" }}>
                                                                                                    ...
                                                                                                    <div className="shopping-card-list-item-pic w-25 ">
                                                                                                        <Link href={`/product/${getUrl(q.enTitle ? q.enTitle : q.productName)}`}>
                                                                                                            <a href="">
                                                                                                                <img className="w-50" src={`${ServerFileIdentifier()}${q.coverFile}`} />
                                                                                                            </a>
                                                                                                        </Link>
                                                                                                    </div>
        ...
        {q.brandName}
                                                                                                    ...
                                                                                                    {/* <div className="shopping-card-list-item-price text-dark  w-25">
                                                                                            {
                                                                                                getCount(q.id).payload && getCount(q.id).payload <= 1 ?
                                                                                                    ...
                                                                                                    <div className="shopping-card-list-item-actions">
                                                                                                        <span className="" onClick={() => handleShow(q.productId, false)}>
                                                                                                            X
                                                                                                        </span>
                                                                                                    </div>
                ...
                >
                    <Modal.Body>
                        {<h6 className='font-weight-bold'>آیا می خواهید این محصول را از لیست علاقه مندی ها  حذف کنید ؟</h6>}
                    ...
                    <Modal.Footer>
                        ...
                        <button type="button" onClick={() => addFavoriteProduct()} class={"btn btn-danger"}> {'حذف'} </button>
