...
const TableInit = ({ onChangeAction, deleteArticle, loading }) => {
  const intl = useIntl();
  ...
  return [
...

    {
      ...
      dataIndex: "videoCategoryTitle",
      key: "videoCategoryTitle",
      sorter: false,
    },
    ...
    {
      title: <FormattedMessage id="videoSource" />,
      dataIndex: "videoSourceTitle",
      key: "videoSourceTitle",
      sorter: false,
    },
