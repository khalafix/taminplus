...
const TableInit = ({ onChangeAction, deleteBanner, loading }) => {
  const intl = useIntl();
  ...
  return [
    ...
    // },
    {
      title: <FormattedMessage id="positionPlace" />,
      dataIndex: "positionPlaceTitle",
      key: "positionPlaceTitle",
      sorter: false,
    },
